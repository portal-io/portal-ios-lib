...
/**
 Pause The Animation When Life Cycle Is Changed If Needed (Like viewDidDisappear:)
 */
- (void)suspend;

/**
 Restart The Animation When Life Cycle Is Changed If Needed (Like viewDidAppear:)
 */
- (void)resume;
